...
$sql="SELECT *,TIME_FORMAT(heure_convocation,'%Hh:%Imn') AS heure_convocations,DATE_FORMAT(date_convocation,'%d-%m-%Y') AS dateConvocation,DATE_FORMAT(date_debut,'%d-%m-%Y') AS date_debuts,DATE_FORMAT(date_expiration,'%d-%m-%Y') AS date_expirations
